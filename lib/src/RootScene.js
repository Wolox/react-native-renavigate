Object.defineProperty(exports,"__esModule",{value:true});exports.routeInstancePropType=undefined;var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _jsxFileName='src/RootScene.js';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=require('react');var _react2=_interopRequireDefault(_react);
var _reactNativeCustomComponents=require('react-native-custom-components');
...
return(
_react2.default.createElement(_reactNativeCustomComponents.Navigator,{
...
navigationBar:this.props.navigationBar(this.props.dispatch,navigationBarProps),__source:{fileName:_jsxFileName,lineNumber:127}}));
...
navigationStyles:_reactNativeCustomComponents.Navigator.NavigationBar.propTypes.navigationStyles,
...
decorateRouteComponent:function decorateRouteComponent(RouteComponent,params){return _react2.default.createElement(RouteComponent,_extends({},params,{__source:{fileName:_jsxFileName,lineNumber:171}}));},
defaultTransition:_reactNativeCustomComponents.Navigator.SceneConfigs.PushFromRight,
navigationBar:function navigationBar(dispatch,props){
return(
_react2.default.createElement(_reactNativeCustomComponents.Navigator.NavigationBar,_extends({
routeMapper:(0,_navigationBarRouteMapper2.default)(dispatch)},
props,{__source:{fileName:_jsxFileName,lineNumber:175}})));
